...
#define CONFIG_DM9000A_BASE		0x08000000
#define CS3_PIN                                     (32 + 27) 
static struct resource dm9000a_resource[] = {
	[0] = {
		.start	= CONFIG_DM9000A_BASE,
		.end	= CONFIG_DM9000A_BASE + 3,
		.flags	= IORESOURCE_MEM
	},
	[1] = {
		.start	= CONFIG_DM9000A_BASE + 4,
		.end	= CONFIG_DM9000A_BASE + 0xF,
		.flags	= IORESOURCE_MEM
	},
	[2] = {
		.start	= IRQ_GPIO_0+CS3_PIN,
		.end	= IRQ_GPIO_0+CS3_PIN,
		.flags	= IORESOURCE_IRQ
	}
};

static struct dm9000_plat_data dm9000a_platdata = {
	.flags		= DM9000_PLATF_16BITONLY,
};

static struct platform_device dm9000a_device = {
	.name		= "dm9000a",
	.id		= 0,
	.num_resources	= ARRAY_SIZE(dm9000a_resource),
	.resource	= dm9000a_resource,
	.dev		= {
		.platform_data	= &dm9000a_platdata,
	}
};
